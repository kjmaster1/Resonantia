...
import com.kjmaster.resonantia.modules.smelter.blocks.ResonantAlloySmelterTE;
...
public class GuiResonantAlloySmelter extends GuiModularResonatingMachine<ResonantAlloySmelterTE, GenericContainer> {

    private static final ResourceLocation BURN_PROGRESS_SPRITE = ResourceLocation.withDefaultNamespace("container/furnace/burn_progress");

    public GuiResonantAlloySmelter(GenericContainer container, Inventory inventory, Component title) {
        super(container, inventory, title, ManualEntry.EMPTY);
    }

    public static void register(RegisterMenuScreensEvent event) {
        event.register(SmelterModule.CONTAINER_RESONANT_ALLOY_SMELTER.get(), GuiResonantAlloySmelter::new);
    }
    ...
    protected void renderBg(@NotNull GuiGraphics graphics, float partialTicks, int x, int y) {
        ...
        ResonantAlloySmelterTE te = (ResonantAlloySmelterTE) this.menu.getBe();
