package com.kjmaster.resonantia.modules.crusher.client;
...
public class GuiResonantCrusher extends GuiModularResonatingMachine<ResonantCrusherTE, GenericContainer> {

    private static final ResourceLocation BURN_PROGRESS_SPRITE = ResourceLocation.withDefaultNamespace("container/furnace/burn_progress");

    public GuiResonantCrusher(GenericContainer container, Inventory inventory, Component title) {
        super(container, inventory, title, ManualEntry.EMPTY);
    }

    public static void register(RegisterMenuScreensEvent event) {
        event.register(CrusherModule.CONTAINER_RESONANT_CRUSHER.get(), GuiResonantCrusher::new);
    }
    ...
    protected void renderBg(@NotNull GuiGraphics graphics, float partialTicks, int x, int y) {
        ...
        ResonantCrusherTE te = (ResonantCrusherTE) this.menu.getBe();
